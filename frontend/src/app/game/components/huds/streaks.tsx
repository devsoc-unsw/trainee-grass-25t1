      ...
      >
        ...
        <div className="flex justify-center gap-4">
          <div className="grid grid-cols-2 h-96 overflow-y-auto">
            <span className="absolute text-2xl left-20 top-25">
              Streak Count:
            </span>
            <span className="absolute text-2xl left-130 top-25">{streak}</span>
            <span className="absolute text-2xl left-20 top-55">
              days Skipped:
            </span>
            <span className="absolute text-2xl left-115 top-55">
              Coming Soon
            </span>
            <span className="absolute text-2xl left-20 top-85">
              currentDayCompleted:
            </span>
            <span className="absolute text-2xl left-115 top-85">
              Coming Soon
            </span>
          </div>
        </div>
